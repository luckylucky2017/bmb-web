  ...
  helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        connectSrc: ["'self'"],
        // Embedded video (Quill/TinyMCE video button) only ever points at
        // these trusted providers — enforced server-side too, see
        // allowedIframeHostnames in models/sanitizeContent.js.
