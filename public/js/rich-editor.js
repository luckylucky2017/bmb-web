// Shared TinyMCE setup used by both the product description editor and the
// custom page editor. See product-editor.js / page-editor.js for the thin
// per-form wrappers that call this with their own upload endpoint/form id.
function initRichEditor({ uploadUrl, formId, placeholder }) {
  const EDITOR_ID = "description-editor";
  const targetEl = document.getElementById(EDITOR_ID);
  ...
  function uploadImage(file) {
    ...
    return fetch(uploadUrl, { method: "POST", body: formData }).then((res) => {
